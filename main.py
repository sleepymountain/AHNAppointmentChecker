...
def start():
    ...
    print(Fore.GREEN + 'AHN Appointment Checker v1.5b | by caverin/sleepymountain')
    print(Fore.GREEN + 'https://github.com/sleepymountain/AHNAppointmentChecker')
    print(f'')
    print(Fore.BLUE + '[i] Running appointment checker..')
    print(f'')
...
def load_page():
    with webdriver.Chrome(options=chrome_options) as driver:
        ...
        print(Fore.BLUE + '[i] Checking for new appointments..')
        ...
        if driver.find_element_by_xpath("/html/body/main/div[2]/div/section/div/div/div/div[1]/div/h1"):
            print(Fore.RED + dt_string, " | There are no appointments available")
            logging.info(' | There are no appointments available')
            print(f'')
        else:
            print(Fore.GREEN + "[!]", dt_string, " | There might be appointments available!")
            ...
            os.startfile(url)
        print(Fore.BLUE + '[i] Waiting 5 minutes.')
        time.sleep(300)
